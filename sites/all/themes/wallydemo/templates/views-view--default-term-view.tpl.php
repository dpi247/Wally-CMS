...
<div id="une_bis">
  ...
  <div class="right pager"><?php print _wallydemo_pager('',10,0,array('tid'=>$tid),9);?> </div>
  </div>
  <?php if ($admin_links): ?>
  ...
  <?php endif; ?>
  <div class="pagin"><?php echo $breadcrumb; ?> <?php print _wallydemo_pager('',10,0,array('tid'=>$tid),9);?></div>
</div>
