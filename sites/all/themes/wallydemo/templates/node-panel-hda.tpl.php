...
//drupal_add_js(drupal_get_path('theme', 'custom_sp').'/scripts/cycle.js');
...
<h3><?php print $main_title; ?></h3>
<p class="story_date"><?php print $date_edition; ?></p>
<div id="wrap_illu">
  <p><?php print $mainObject_html; ?></p>
</div>
<?php print $chapeau; ?>
<?php print $texte_article; ?> 
<a href="/homme_de_l_annee_liege/participation/?page=vote" class="voter">Voter</a>
<!-- Pour Googleplus --> 
