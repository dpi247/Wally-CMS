...
<div class="carte"> <img src="/<?php print $my_data['medias_folder'] ?>_sp/D0.png" width="428" height="349" />
  <p class="rose_vents">Vent de <?php print $my_data['today']['vit']; ?><acronym title="Kilom&egrave;tre par heure">km/h</acronym>, Secteur <?php print $my_data['today']['sect']; ?></p>
</div>
</div>
<?php 
//unset variables
