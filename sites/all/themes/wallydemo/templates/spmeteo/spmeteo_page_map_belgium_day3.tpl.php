...
<div id="letemps">
  ...
  <div class="carte"> <img src="/<?php print $my_data['medias_folder'] ?>_sp/D2.png" width="428" height="349" />
    <p class="rose_vents">Vent de <?php print $my_data['day3']['vit']; ?><acronym title="Kilom&egrave;tre par heure">km/h</acronym>, Secteur <?php print $my_data['day3']['sect']; ?></p>
  </div>
</div>
<?php
//unset variables
