...
//
  ...
  $photo = $result["wallynode"][0];
	...
	switch($type) {
		// main
		case "main_size":
			$photo_display = theme('imagecache', 'search_150x100', $embed_photo['filename'], $embed_photo['title'],$embed_photo['title'].$embed_photo['credit']);
			$html .= "<li><a href='".$node_path."'>".$photo_display."</a></li>";
			break;
