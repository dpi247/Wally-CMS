...
<div class="bloc_sondage bloc-01">
  <h2><a href="<?php print drupal_get_path_alias("/services/les_sondages/")?>">Sondages</a></h2>
  <div class="inner-bloc">
    ...
    <?php endif; ?>
    <div class="allpolllink"><a href="services/les_sondages/" class="arrow novisited">Tous les sondages</a></div>
  </div>
</div>
<?php /* class view */ ?>
