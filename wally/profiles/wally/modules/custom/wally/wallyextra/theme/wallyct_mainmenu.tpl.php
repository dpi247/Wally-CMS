...
function wallyct_mainmenu_tree_output($tree, $menuid="menu-primary-links", $firstpass=1) {
    ...
    if ($firstpass==1) {
      drupal_add_css(drupal_get_path('module', 'wallyextra') . '/css/superfish/superfish.css', 'theme');
      drupal_add_js(drupal_get_path('module', 'wallyextra') . '/scripts/superfish/hoverIntent.js', 'theme');
      drupal_add_js(drupal_get_path('module', 'wallyextra') . '/scripts/superfish/superfish.js','theme');
