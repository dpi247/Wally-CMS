...
<object id="<?php print $video_id; ?>" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="<?php print $options['width']; ?>" height="<?php print $options['height']; ?>">
	<param name="movie" value="http://www.rtl.be/videos/GED_vp/00230000/237200/237206.swf?bEmbed=1&bHideInfo=0&VideoID=<?php print $options['video_id']; ?>&sDummyPath=/videos"></param>
	<param name="allowFullScreen" value="<?php print $options['fullscreen']; ?>"></param>
	<param name="allowscriptaccess" value="always"></param>
	<embed src="http://www.rtl.be/videos/GED_vp/00230000/237200/237206.swf?bEmbed=1&bHideInfo=0&VideoID=<?php print $options['video_id']; ?>&sDummyPath=/videos" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="<?php print $options['width']; ?>" height="<?php print $options['height']; ?>"></embed>
</object>
</div>
