<frame type="4" fontsize="22" maxCapacity="45" minCapacity="41" width="376" height="30.75" textlines="1" id="1">
...
<?php if ($photoobject != NULL && $photoobject->field_photofile[0]['filename'] != NULL){
  ...
  ?>
  <frame type="2" fontsize="" maxCapacity="" minCapacity="" width="182" height="110.25" id="2">
    <![CDATA[
      <photoinfo>
...
<?php }?>
<frame type="4" fontsize="12.5" maxCapacity="674" minCapacity="554" width="182" height="220" textlines="" id="3">
