...
<?php if ($photoobject != NULL && $photoobject->field_photofile[0]['filename'] != NULL){
  ...
  ?>
  <frame type="2" fontsize="" maxCapacity="" minCapacity="" width="182" height="192.75">
    <![CDATA[
      <photoinfo>
...
<?php }?>
<frame type="4" fontsize="12.5" maxCapacity="435" minCapacity="377" width="182" height="206" textlines="">
