	...
	<div class="p-wrap">
		<div class="p-the-content" style="padding-top:20px;">
			<div id="divtochange">
				...
				<div class="row">
					<label for="mmdp"><span>*</span>Password :</label>
					<input type="password" class="form-text" name="mmdp" id="mmdp" />
				</div>
				<input type="submit" class="btn-submit" value="<?php echo $title;?>" />
				</form><div class="row" id="fgpwd"><a href="<?php echo SSO_FORGET; ?>?aff=FULL&amp;backurlPDF='+encodeURIComponent(window.location.href)+'">Password forgotten?</a></div>
			</div>
		</div>
